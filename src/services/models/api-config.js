...
export default class HelpCenter {
    ...
    static async getHelpType() {
        return await get(baseUrl + '/v1/help/type.json')
    }
    //写出相对应获取资源的方法
    static async getVideoItem(data) {
        return await get(baseUrl + '/v1/help/videoItem.json', data)
    }
    static async getVideo(data) {
        return await get(baseUrl + '/v1/help/video.json', data)
    }
    static async getQuestion(data) {
        return await get(baseUrl + '/v1/help/question.json', data)
    }
}